...
public class historyTable extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        historyTbl.setBackground(new java.awt.Color(89, 74, 71));
        historyTbl.setFont(new java.awt.Font("MS UI Gothic", 1, 16)); // NOI18N
        historyTbl.setForeground(new java.awt.Color(252, 231, 208));
        ...
        historyTbl.setGridColor(new java.awt.Color(255, 255, 255));
        ...
        historyTbl.setSelectionBackground(new java.awt.Color(252, 231, 208));
        historyTbl.setSelectionForeground(new java.awt.Color(89, 74, 71));
        historyTbl.setShowGrid(false);
