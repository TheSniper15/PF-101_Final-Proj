...
public class adminFrame extends javax.swing.JFrame {
	...
	@SuppressWarnings("unchecked")
        ...
        private void initComponents() {
                ...
                getContentPane().add(userpanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(1190, 40, -1, -1));

                BG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/group2/background/Admin.jpg"))); // NOI18N
